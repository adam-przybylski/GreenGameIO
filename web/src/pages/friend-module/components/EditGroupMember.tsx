...
const EditGroupMember: FC = ({ member, id, groupID }) => {
    const removeGroupMember = () => {
        api.removeGroupMember(id, groupID, member.id);
    };
    return (
        <div className="friend" id={member.id}>
            <div id="name">
                <h2>{member.username}</h2>
            </div>
            <div id="buttons">
                <button className="button" onClick={removeGroupMember}>

...
public class GreenGameIoApplication {
    ...
    CommandLineRunner commandLineRunner(UserRepository userRepository, NotificationRepository notificationRepository, UserNotificationRepository userNotificationRepository) {
        return args -> {
            ...
            var user = userRepository.save(new User("admin", "$2b$12$6J4h6z.Er73Ud7zWhUT4yueCCFl2xCLkUZGHi8JtJYYwxp3NHtbBK", "admin@email.com", UserType.ADMINISTRATOR));
            userRepository.save(new User("user", "$2b$12$6J4h6z.Er73Ud7zWhUT4yueCCFl2xCLkUZGHi8JtJYYwxp3NHtbBK", "user@email.com", UserType.USER));
            ...
            userNotificationRepository.save(new UserNotification("UserTitle1", "UserContent1",true, user));
            userNotificationRepository.save(new UserNotification("UserTitle2", "UserContent2",true, user));
            userNotificationRepository.save(new UserNotification("UserTitle3", "UserContent3",false, user));
        };
    }

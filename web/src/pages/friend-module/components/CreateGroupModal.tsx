    ...
    return (
        <div>
            ...
            <div id="modal">
                ...
                <div id="input">
                   <input value={groupName} type="text" name="group-name" id="group-name" placeholder="Nazwa" onChange={evt => setGroupName(evt.target.value)}></input>
                   <input value={groupDescription} type="text" name="group-description" id="group-description" placeholder="Opis" onChange={evt => setGroupDescription(evt.target.value)}/>
                   <button className="button" onClick={createGroup}>Stwórz</button>
                </div>
             </div>
        </div> 
        </div>
